...
INSERT INTO products (name, price, can_be_returned) VALUE ('chair', 44.00, 'f');
...
INSERT INTO products (name, price, can_be_returned) VALUES ('desk', 100.00, 't');
8.	Display only the products that can_be_returned
SELECT name, price, can_be_returned FROM products WHERE can_be_returned IN ('t'); 
